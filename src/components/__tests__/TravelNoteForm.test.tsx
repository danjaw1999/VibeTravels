...
describe("TravelNoteForm", () => {
  ...
  it("submits form with correct data", async () => {
    ...
    await user.type(screen.getByTestId("description-input"), "Amazing view of the sunset");
    ...
    await waitFor(() => {
      expect(global.fetch).toHaveBeenCalledWith("/api/travel-notes", expect.any(Object));
