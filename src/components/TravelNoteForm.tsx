...
export default function TravelNoteForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" data-testid="travel-note-form">
      <div className="space-y-2">
        ...
        />
        {errors.name && (
          <p id="name-error" className="text-sm font-medium text-destructive" data-testid="name-error">
            {errors.name.message}
          </p>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        {errors.description && (
          <p id="description-error" className="text-sm font-medium text-destructive" data-testid="description-error">
